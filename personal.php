			...
			<div class="geektext-entry">
				<div class="row">
					<div class="col-md-10">
						...
						<div class="card-element"><?php echo $user["name"];?></div>					
					</div>
					<div class="col-md-2 d-flex align-items-start justify-content-start justify-content-md-end">
				...
				<form class="row hidden" method="post">
					...
					<div class="col-md-4 d-flex align-items-start justify-content-start justify-content-md-end">
			...
			<div class="geektext-entry">
				<div class="row">
					<div class="col-md-10">
						...
						<div class="card-element"><?php echo $user["nickname"];?></div>					
					</div>
					<div class="col-md-2 d-flex align-items-start justify-content-start justify-content-md-end">
						<button type="button" class="btn btn-outline-primary geektext-btn geektext-edit">Edit</button>
					</div>
			...
			<div class="geektext-entry">
				<div class="row">
					<div class="col-md-10">
						...
						<div class="card-element"><?php echo $user["email"];?></div>					
					</div>
					<div class="col-md-2 d-flex align-items-start justify-content-start justify-content-md-end">
						<button type="button" class="btn btn-outline-primary geektext-btn geektext-edit">Edit</button>
					</div>
